...
void Blowfish::encipher_block(unsigned long* l,unsigned long* r) {
	unsigned long xl=*l;
	unsigned long xr=*r;
...
void Blowfish::decipher_block(unsigned long* l,unsigned long* r) {
	unsigned long xl=*l;
	unsigned long xr=*r;
	unsigned long temp;
...
unsigned long Blowfish::F(unsigned long f) {
	unsigned long y = _s[0][(x>>24)&0xff] + _s[1][(x>>16)&0xff];
	y ^= _s[2][(x>>8)&0xff];
	return y + _s[3][x&0xff];
}

Blowfish::Blowfish(){
	memcpy(_p,Blowfish::p,sizeof(Blowfish::p));
	memcpy(_s,Blowfish::s,sizeof(Blowfish::s));
}

void Blowfish::update(const char* key,unsigned int keylen){

}

void Blowfish::reset();
void Blowfish::encipher(const char* data,unsigned int len,char* out);
void Blowfish::decipher(const char* data,unsigned int len,char* out);
...
unsigned long Blowfish::p[18] = {
	0x243f6a88, 0x85a308d3, 0x13198a2e, 0x03707344, 0xa4093822, 0x299f31d0, 0x082efa98, 0xec4e6c89,
	0x452821e6, 0x38d01377, 0xbe5466cf, 0x34e90c6c, 0xc0ac29b7, 0xc97c50dd, 0x3f84d5b5, 0xb5470917,
    0x9216d5d9, 0x8979fb1b };

unsigned long Blowfish::s[4][256] = {
	{
